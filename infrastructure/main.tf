...
locals {
  ...
  case_formatter_baseurl    = "http://nfdiv-cfs-${local.local_env}.service.core-compute-${local.local_env}.internal"
  draft_store_api_baseurl   = "http://draft-store-service-${local.local_env}.service.core-compute-${local.local_env}.internal"
  petitioner_fe_baseurl     = "https://nfdiv-pfe-${local.local_env}.service.core-compute-${local.local_env}.internal"
